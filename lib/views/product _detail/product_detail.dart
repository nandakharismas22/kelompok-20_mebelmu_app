...
import 'package:furniture_shopping_app_ui/res/components/dummy_product_lists.dart'; // Pastikan untuk mengimpor DummyProductList
...
class _ProductDetailState extends State<ProductDetail> {
  ...
  void initState() {
    super.initState();
    isFavorite = DummyProductList.wishlist.contains(widget.productModel);
  }
            ...
            children: [
              ...
              Positioned(
                ...
                child: GestureDetector(
                  onTap: () {
                    var isAdded = Utils.addToWish(widget.productModel);
                    if (isAdded) {
                      setState(() {
                        isFavorite = true;
                      });
                      Utils.wishMessage(message: 'Added to Wishlist!');
                    } else {
                      Utils.wishMessage(message: 'Already in Wishlist');
                    }
                  },
                  child: Container(
                    height: 55,
                    ...
                    child: Icon(
                      ...
                      size: 28,
                      color:
                          isFavorite ? AppColors.redColor : AppColors.grayColor,
                    ),
                  ),
                ),
              ),
            ...
            child: InkWell(
              onTap: () {
                ...
                if (isAdded) {
                  ...
                  Utils.toastMessage(message: 'Already in Cart');
                }
              },
              child: Container(
                height: 65,
